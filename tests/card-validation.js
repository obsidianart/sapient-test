...
var testCases = [
  ...
  ['411111y', {isValid: false}],
  ['41111111111111111111', { isValid: false}], // Too long 
  ['4111 1111 1111 1111', { isValid: true}],
...
test('Luhn10 validation', function (t) {
  // testCases.map([cardNumber, {isValid}]=>{
  //   const validation = luhnTest.validate(cardNumber)
  //   t.equal(validation, isValid, `Test failed on ${cardNumber}`)
  // })
